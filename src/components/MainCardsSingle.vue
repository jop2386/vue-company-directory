...
<style scoped lang="postcss">
  .card {
    @apply cursor-pointer overflow-hidden rounded-md bg-green-100 p-8 shadow-md transition duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-slate-900;
    &-image {
      img {
    ...
    &-details {
      ...
      &-job {
        @apply -mt-2 text-xs font-bold text-slate-500;
      }

      &-quote {
        @apply pt-4 text-lg italic text-slate-900;
      }
    }
  }
</style>
