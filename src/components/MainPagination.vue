...
<style lang="postcss" scoped>
  .pagination {
    ...
    .action {
      @apply rounded-md bg-yellow-100 p-2 font-medium text-slate-700 shadow-md hover:bg-yellow-200 disabled:text-slate-400 hover:disabled:bg-slate-100;
    }
    .page {
      @apply rounded-md bg-slate-100 p-2 font-medium text-slate-700 shadow-md hover:bg-slate-200;
      &.active {
        @apply bg-blue-700 text-blue-100 hover:bg-blue-600;
      }
    }
  }
</style>
