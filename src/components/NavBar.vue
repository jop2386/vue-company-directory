  ...
  nav {
    ...
    .wrapper {
      ...
      .menu {
        ...
        &-login {
          @apply rounded-md bg-yellow-500 px-4 py-2 text-yellow-100 hover:bg-yellow-700;
          &-logout {
            @apply mx-2 rounded-md bg-yellow-500 px-4 py-2 text-yellow-100 hover:bg-yellow-700;
          }
        }
      }
    }
